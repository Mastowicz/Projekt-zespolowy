...
\begin{itemize}
	\item Uruchomienie bazy danych: Należy uruchomić kontener MySQL za pomocą Dockera lub włączyć moduł MySQL w panelu kontrolnym XAMPP. Baza powinna pracować na porcie 8081.
	\item Konfiguracja i start serwera: Należy uruchomić aplikację Spring Boot z poziomu środowiska IDE lub za pomocą wiersza poleceń. Serwer automatycznie stworzy niezbędne tabele w bazie danych przy pierwszym uruchomieniu.
