...
Jak pokazano na rysunku \ref{fig:esp32}, poniżej znajduje się wykorzystany w projekcie moduł ESP32 Wroom podłączony do czujnika DHT11.
\begin{figure}[H]
    \centering
